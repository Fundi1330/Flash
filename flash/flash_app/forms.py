...
class LoginForm(AuthenticationForm):
    ...
    password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'w-full form-input p-1 border-neutral-700 focus:border-neutral-700 focus:outline focus:outline-1 shadow border w-1/4 rounded'}))